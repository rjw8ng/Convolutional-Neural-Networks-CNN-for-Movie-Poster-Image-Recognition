...
* `Convolutional_Neural_Networks_for_Movie_Poster_Image_Recognition.pdf`: Write up of experiments and results
* `Deep Learning Final Project (Final).ipynb`: Final python script consisting of all models
